...
class Test_solve_to(unittest.TestCase):
    ...
    def test_2(self):
        ...
        with self.assertRaises(FunctionError):
            solve_to(fun, t0, y0, t_max=t_max, method='RK4')
    ...
    # Check if no t_max or n_max is given
    def test_6(self):
        fun = lambda t, y: y
        t0 = 0
        y0 = np.array(1)
    ...
    def test_10(self):
        ...
        t_max = 2
        with self.assertRaises(ValueError):
            solve_to(fun, t0, y0, t_max=t_max)
    ...
    def test_13(self):
        ...
        t_max = 'Not a number'
        with self.assertRaises(ValueError):
            solve_to(fun, t0, y0, n_max=t_max)
...
# class Test_szhooting(unittest.TestCase):
#     def __init__(self, *args, **kwargs):
